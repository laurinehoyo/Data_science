...
-   Petite voiture: Toyota's small cars have lower median prices, in keeping with their image as brands offering economical vehicles.

-   SUV / Tout-terrain: SUVs and off-road vehicles present a wide price range and a high maximum, consistent with Volvo having their status as a luxury brand.
...
p1
```
While the category with the most observations is composed of petrol cars, the category with the highest average listing duration is "Diesel".
...
p2
```
This model has the largest panel of categories.
...
p3
```
For this model, the highest average listing duration goes to the category with the most observations, i.e. petrol cars.
...
Like Toyota, there is not much variation in average listing duration, with a 20-day gap between the highest and lowest average listing duration, except for natural gas vehicles, which have a very high listing age.
...
Like Skoda and Toyota, there is not much variation in average listing duration, with a 16-day gap between the highest and lowest average listing duration.
